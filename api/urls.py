...
urlpatterns = patterns("api.views",
                       ...
                       url(r'^api-token-auth/', LoginUser.as_view(), name='token-check'),
                       ...
                       url(r'optimized_route_list/(?P<pk>[a-zA-Z0-9]+)', OptimizedRouteListApi.as_view(),
                           name='optimized-route-list-api'),
                       url(r'edit_route/(?P<pk>[a-zA-Z0-9]+)', EditRouteApi.as_view(), name='edit-route-api'),
                       url(r'optimized_edit_route/(?P<pk>[a-zA-Z0-9]+)', OptimizedEditRouteApi.as_view(),
                           name='optimized-edit-route-api'),
